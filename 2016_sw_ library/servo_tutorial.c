...
void servo_init(void){
  GPIO_InitTypeDef GPIO_InitStructure;
	...
	//------------------------------//
	TIM_TimeBaseStructure.TIM_Prescaler = 143;												//Timer speed = 72e6/(Prescaler+1) Hz
	TIM_TimeBaseStructure.TIM_Period = 10000;												//Counts per pulse, basically max value for SetCompare
	//------------------------------//50Hz
	...
	*/
	...
	//------------------------------//
	TIM_OCInitStructure.TIM_Pulse = 450;														// this part sets the initial CCR value that mean the pwm value
	//------------------------------//
